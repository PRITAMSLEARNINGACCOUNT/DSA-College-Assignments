...
void Postorder(struct Tree *Root_Node)
{
    if (Root_Node != NULL)
    {
        Postorder(Root_Node->Previous_Node);
        Postorder(Root_Node->Next_Node);
...
int main()
{
    ...
    struct Tree *Right_Node_1 = CreateNode(4);
    struct Tree *Right_Node_2 = CreateNode(0);
